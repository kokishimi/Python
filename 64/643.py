# -*- coding: utf-8 -*-
"""
Created on Wed Aug 21 18:51:14 2019
...
def loss(y,t):
    cross_entropy=\
        tf.reduce_mean(-tf.reduce_sum(t*tf.log(tf.clip_by_value(y,1e-10,1.0)),
                                      reduction_indices=[1]))
...
if __name__ == '__main__':    
    tar=tarfile.open(r'C:\Users\kokis\Downloads\tasks_1-20_v1-2.tar.gz')
